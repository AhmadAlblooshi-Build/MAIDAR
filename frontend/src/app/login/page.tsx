            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-cyan-100/90 text-lg leading-relaxed">
                  Measure, predict, explain, and reduce human cyber risk inside organizations with AI-powered behavioral analysis and real-time threat intelligence.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  { value: '99.5%', label: 'Detection Rate', glow: 'from-emerald-400 to-green-500' },
                  { value: '150+', label: 'Organizations', glow: 'from-blue-400 to-cyan-500' },
                  { value: '70%', label: 'Risk Reduction', glow: 'from-purple-400 to-pink-500' }
                ].map((stat, idx) => (
            ...
            <div className="relative backdrop-blur-2xl bg-white/90 rounded-3xl shadow-2xl border border-white/20 p-8 space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-slate-600">
                  {isLogin ? 'Sign in to continue to your dashboard' : 'Get started with Maidar AI Platform'}
                </p>
              </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-4 border-slate-200 border-t-teal-500"></div></div>}>
      <LoginForm />
    </Suspense>
  );
}
